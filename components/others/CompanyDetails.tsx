...
const CompanyDetails = ({ company }: CompanyDetailsProps) => {
  ...
  return (
    <section className="w-full">
      ...
      <div className="flex gap-12 mt-4 m:flex-col xl:flex-col">
        <div className="w-[60%] flex flex-col gap-8 m:w-full xl:w-full">
        ...
        <div className="w-[40%] flex flex-col gap-8 m:w-full xl:w-full">

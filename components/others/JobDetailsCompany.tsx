...
const JobDetailsCompany = ({ company }: JobDetailsCompanyProps) => {
  return (
    <section className="w-[30%] flex flex-col items-center justify-start gap-5 p-3 border-l border-l-gray-200 pl-4 sm:w-full sm:border-none">
      <div className="w-full flex flex-col items-center justify-start gap-4 border-b border-b-gray-200 pb-6 sm:border-t sm:border-t-gray-200 sm:pt-6">
        <Image
          src={company.logo}
          width={50}
          height={50}

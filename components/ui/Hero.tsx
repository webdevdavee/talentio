...
const Hero = async () => {
  ...
  return (
    <section className="relative flex items-start w-full max-h-[37rem] py-20 px-16 hero overflow-hidden sm:block sm:px-4 sm:py-8">
      <div className="w-[60%] flex flex-col gap-8 items-start sm:w-full">
        <HeroTitle />
        <SearchForm
      ...
      <div className="relative w-[40%] flex items-center justify-center sm:hidden">
        <Image
